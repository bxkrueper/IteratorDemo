 ...
 * 
 * Purpose: this class is a custom built binary tree set with its own private
 * iterator and node class. It has minimal functionality and is just for demonstration
 */
package example;
